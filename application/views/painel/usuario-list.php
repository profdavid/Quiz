                                                ...
                                                <tbody>
                                                    ...
                                                    <tr {COR_INATIVO}>
                                                    	...
                                                    	<td class="text-center">
                                                    		<button type="button" class="tabledit-delete-button btn btn-default" onclick="chamaExcluir({id}, '{usunome}')"><span class="feather icon-trash-2 f-16 text-c-red"></span></button>
                                                    	</td>
                                                    </tr>
                                                    {/LIST_DADOS}
                                                </tbody>
